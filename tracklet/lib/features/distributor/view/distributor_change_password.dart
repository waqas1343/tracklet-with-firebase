...
class DistributorChangePassword extends StatefulWidget {
  const DistributorChangePassword({super.key});

  @override
  State<DistributorChangePassword> createState() => _ChangePasswordScreenState();
}

class _ChangePasswordScreenState extends State<DistributorChangePassword> {
