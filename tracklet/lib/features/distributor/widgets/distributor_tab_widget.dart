...
/// DistributorTabWidget: Reusable tab widget for distributor navigation
///
/// Provides consistent tab styling with icon, title, and active state
class DistributorTabWidget extends StatelessWidget {
  final IconData icon;
  final String title;
  final bool isActive;
