...
/// InProgressOrderCard: Reusable card for in progress orders
///
/// Displays in progress order information with exact design from image
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Header with company name and in progress status
            Row(
              ...
              children: [
                Expanded(
                  child: CustomButton(
                    ...
                    textColor: AppColors.buttonTextSecondary,
