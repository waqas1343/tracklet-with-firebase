...
/// CancelledOrderCard: Reusable card for cancelled orders
///
/// Displays cancelled order information with exact design from image
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Header with company name and cancelled status
            Row(
